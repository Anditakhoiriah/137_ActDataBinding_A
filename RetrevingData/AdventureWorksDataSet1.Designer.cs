...
namespace RetrevingData {
    ...
    public partial class AdventureWorksDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string NationalIDNumber, int ContactID, string LoginID, EmployeeRow parentEmployeeRowByFK_Employee_Employee_ManagerID, string Title) {
...
namespace RetrevingData.AdventureWorksDataSet1TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [HumanResources].[Employee] SET [NationalIDNumber] = @NationalIDNumber, [ContactID] = @ContactID, [LoginID] = @LoginID, [ManagerID] = @ManagerID, [Title] = @Title WHERE (([EmployeeID] = @Original_EmployeeID) AND ([NationalIDNumber] = @Original_NationalIDNumber) AND ([ContactID] = @Original_ContactID) AND ([LoginID] = @Original_LoginID) AND ((@IsNull_ManagerID = 1 AND [ManagerID] IS NULL) OR ([ManagerID] = @Original_ManagerID)) AND ([Title] = @Original_Title));
SELECT EmployeeID, NationalIDNumber, ContactID, LoginID, ManagerID, Title FROM HumanResources.Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RetrevingData.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, NationalIDNumber, ContactID, LoginID, ManagerID, Title FROM Hu" +
                "manResources.Employee";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_NationalIDNumber, int Original_ContactID, string Original_LoginID, global::System.Nullable<int> Original_ManagerID, string Original_Title) {
        ...
        public virtual int Update(string NationalIDNumber, int ContactID, string LoginID, global::System.Nullable<int> ManagerID, string Title, int Original_EmployeeID, string Original_NationalIDNumber, int Original_ContactID, string Original_LoginID, global::System.Nullable<int> Original_ManagerID, string Original_Title, int EmployeeID) {
            ...
            if ((Original_NationalIDNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_NationalIDNumber));
            }
            ...
            if ((Original_ManagerID.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_ManagerID.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NationalIDNumber, int ContactID, string LoginID, global::System.Nullable<int> ManagerID, string Title, int Original_EmployeeID, string Original_NationalIDNumber, int Original_ContactID, string Original_LoginID, global::System.Nullable<int> Original_ManagerID, string Original_Title) {
            return this.Update(NationalIDNumber, ContactID, LoginID, ManagerID, Title, Original_EmployeeID, Original_NationalIDNumber, Original_ContactID, Original_LoginID, Original_ManagerID, Original_Title, Original_EmployeeID);
        }
    }
